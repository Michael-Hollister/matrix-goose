...
impl LoginBuilder {
    ...
    fn new(client: GooseMatrixClient, login_method: LoginMethod) -> Self {
        Self {
            client,
            login_method,
            device_id: None,
    ...
    pub(super) fn new_password(client: GooseMatrixClient, id: UserIdentifier, password: String) -> Self {
        Self::new(client, LoginMethod::UserPassword { id, password })
    }

    // pub(super) fn new_token(client: Client, token: String) -> Self {
    pub(super) fn new_token(client: GooseMatrixClient, token: String) -> Self {
